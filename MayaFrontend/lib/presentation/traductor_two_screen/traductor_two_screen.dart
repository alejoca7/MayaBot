...
class TraductorTwoScreen extends StatelessWidget {
  ...
  void _onTapTraducir(BuildContext context) async {
    String mayaWord = textEditingControllerQeqchi.text;
